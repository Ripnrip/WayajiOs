...
class ExploreViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func loadListings() {
        ...
        let listing5 = Listing(image: #imageLiteral(resourceName: "hotelSkylar"), images: nil , name: "Hotel Skylar", location: "Fingerlakes, New York", stars: 4, isFavorited: false, URL: URL(string: "https://www.tripadvisor.com/Hotel_Review-g48713-d2138174-Reviews-Hotel_Skyler-Syracuse_Finger_Lakes_New_York.html"), description: "Syracuse’s first LEED Platinum hotel is a unique combination of industrial minimalism and soothing organic touches. Retro and metro mingle in their original guest rooms that are as eclectic as they are comfortable. From the moment you digitally check in until you reluctantly say goodbye, you’ll know you’re somewhere specially designed to nurture your spirit while protecting the planet. ")
